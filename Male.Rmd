...
A new  preventative aides (abacavirinol) is under test in clinical trials. We are analyzing the effectiveness of this drug for females. We are considering the male population. We obtained data from avast, which consists of six variables: x, treatment, sex, infected, Ivdrug, and LBGT. 
...
```{r}
mytab <- xtabs(~infected+treatment, data=male)
rowPerc(mytab)
colPerc(mytab)
```
...
$H_0$ : There is a relationship between being a male and the positive effectiveness of the drug.

$H_A$ : There is no relationship between being a male and the positive effectiveness of the drug.
